...
//    self.detailViewController = (DetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
    ...
    Title =  [[NSMutableArray alloc] initWithObjects:@"BCITSA + SNS", @"The Link", @"Bus Map", @"Campus Map", @"Studyrooms", @"BCIT + SNS", @"BCIT Phonebook", @"My BCIT", @"About", nil];
    Desc  =  [[NSMutableArray alloc] initWithObjects:@"BCITSA Web Facebook Twitter", @"BCIT Magazine", @"Real-time BusMap around BCIT", @"Campus Map", @"Book Strudyrooms", @"BCIT Web Facebook Twitter", @"Call BCIT Offices", @"My BCIT Web", @"About this app",nil];
